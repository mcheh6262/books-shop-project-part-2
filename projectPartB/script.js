...
function presentData(books) {
  ...
  <img class="card-img-top" src="  ${element.volumeInfo.imageLinks.smallThumbnail}" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">  ${element.volumeInfo.title}</h5>
    <p class="card-text">author:  ${element.volumeInfo.authors[0]}.</p>
    <a href="#" class="btn btn-primary" onclick="clickFunction()">to buy</a>
  </div>
</div>
...
function clickFunction(){
  ...
  Swal.fire({
    title: 'For a good order, fill in your details: <br/> first name + last name:', 
    input: 'text',
    inputAttributes: {
      autocapitalize: 'off'
    },
    span: 'For a good order, fill in your details: <br/> first name + last name:', 
    input: 'text',
    inputAttributes: {
      autocapitalize: 'off'
    },
